      ...
      <div className="App">
        <div className="col-5 left-container">
          ...
          <div className="list-inline">
            ...
            <h5>or through</h5>
            <div>
              <a target="_blank" href="https://www.github.com/chrome289" className="media-buttons fab fa-github"></a>
              <a target="_blank" href="https://www.instagram.com/siddharthseth289" className="media-buttons fab fa-instagram"></a>
        ...
        <div className="col-7 right-container">
          <div className="content">
            <h3>About Me</h3>
            <p>
              I am a software developer from Lucknow, India. I have worked on and published several Android Apps, which are available on the <a target="_blank" href="https://play.google.com/store/apps/developer?id=Siddharth+Seth">Google Play Store</a> and on my <a target="_blank" href="https://www.github.com/chrome289">Github page</a>.
          </p>
            <p>
            ...
            <p>
              Do check out my Projects and Résumé below and get in touch if you find it interesting.
          </p>
          </div>
